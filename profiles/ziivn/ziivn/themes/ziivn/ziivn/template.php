 ...
 */
function ziivn_preprocess_maintenance_page(&$vars)
{
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // ziivn_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  ziivn_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function ziivn_preprocess_html(&$vars)
{
 ...
 */
function ziivn_preprocess_page(&$vars)
{
 ...
 */
function ziivn_node_add_list($variables)
{
 ...
 */
function ziivn_admin_block_content($variables)
{
  $content = $variables['content'];
  $output = '';
  if (!empty($content))
 ...
 */
function ziivn_tablesort_indicator($variables)
{
...
function ziivn_breadcrumb($variables)
{
  ...
  if (!empty($breadcrumb))
  {
    ...
    {
      $crumbs .= '<li>' . $value . '</li><li class="btrail"> / </li>';
    }
